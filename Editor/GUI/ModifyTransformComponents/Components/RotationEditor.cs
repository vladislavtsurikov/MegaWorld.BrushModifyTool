    ...
    public class RotationEditor : ReorderableListComponentEditor
    {
        ...
        public override void OnGUI(Rect rect, int index)
        {
            ...
            rect.y += EditorGUIUtility.singleLineHeight;
            {
                ...
                {
                    _settings.ModifyRandomRotationValues.x = CustomEditorGUI.Slider(
                        new Rect(rect.x, rect.y, rect.width, EditorGUIUtility.singleLineHeight),
                ...
                {
                    _settings.ModifyRotationValues.x = CustomEditorGUI.Slider(
                        new Rect(rect.x, rect.y, rect.width, EditorGUIUtility.singleLineHeight),
            ...
            _settings.ModifyRandomRotationY = CustomEditorGUI.Toggle(
                new Rect(rect.x, rect.y, rect.width, EditorGUIUtility.singleLineHeight),
            ...
            rect.y += EditorGUIUtility.singleLineHeight;
            {
                ...
                {
                    _settings.ModifyRandomRotationValues.y = CustomEditorGUI.Slider(
                        new Rect(rect.x, rect.y, rect.width, EditorGUIUtility.singleLineHeight),
                ...
                {
                    _settings.ModifyRotationValues.y = CustomEditorGUI.Slider(
                        new Rect(rect.x, rect.y, rect.width, EditorGUIUtility.singleLineHeight),
            ...
            _settings.ModifyRandomRotationZ = CustomEditorGUI.Toggle(
                new Rect(rect.x, rect.y, rect.width, EditorGUIUtility.singleLineHeight),
            ...
            rect.y += EditorGUIUtility.singleLineHeight;
            {
                ...
                {
                    _settings.ModifyRandomRotationValues.z = CustomEditorGUI.Slider(
                        new Rect(rect.x, rect.y, rect.width, EditorGUIUtility.singleLineHeight),
                ...
                {
                    _settings.ModifyRotationValues.z = CustomEditorGUI.Slider(
                        new Rect(rect.x, rect.y, rect.width, EditorGUIUtility.singleLineHeight),
